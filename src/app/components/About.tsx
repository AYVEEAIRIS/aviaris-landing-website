    ...
    <section id="about">
      <Container sx={{ paddingTop: '4rem' }}>
        <Typography variant="h3" fontWeight={700} gutterBottom>
          At Aviaris (AY-vee-AIR-iss), our mission is to empower operational
          teams to turn strategy into action through a unified platform.
        </Typography>

        <Typography
          variant="body1"
          sx={{ marginTop: '1rem', maxWidth: '700px' }}
        >
        ...
        <Box sx={{ marginTop: '2rem' }}>
          ...
          <ul>
            ...
            <li>
              <strong>Reliability</strong> — Provide fast, stable, and
              predictable performance.
            </li>
            <li>
              <strong>Transparency</strong> — Communicate honestly with
